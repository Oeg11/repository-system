        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#brand">
                    ...
                    <!--<img src="{{ asset('assets/img/logo.jpg') }}"  class="logo" alt="logo" style="border-radius: 50%">-->
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="button-holder">
                        ...
                        <button type="button" class="btn btn-blue navbar-btn" ><a href="{{ route('view_login')}}" class="css-href">Login as Student</a></button>
                       </li>
                ...
                <div class="col-md-5">
                  ...
                  <form class="signup-form"  method="POST">
                    ...
                    @csrf
                        ...
                        <h2 class="text-center">Login as Staff</h2>
                        ...
                        <div class="form-group text-center">
                            ...
                            <button type="button" class="btn btn-blue btn-block btn-stafflogin">Login</button>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="thumbnail team-member">
                        ...
                        <img src="{{ asset('assets/img/Bea-copy.jpg') }}" class="img-responsive img-circle" alt="team-1">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="thumbnail team-member">
                        ...
                        <img src="{{ asset('assets/img/Geo-copy.jpg') }}" class="img-responsive img-circle" alt="team-2">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="thumbnail team-member">
                        ...
                        <img src="{{ asset('assets/img/Lawrence-copy.jpg') }}" class="img-responsive img-circle" alt="team-3">
...
<script>
    ...
    $(document).ready(function() {
        $('.btn-stafflogin').click(function(e) {
          e.preventDefault();

          // Show loading icon and disable button
          $('#button-text').hide();
          $('#button-loading').show();
          $('.btn-stafflogin').attr('disabled', true);
          ...
          var timeout = setTimeout(function() {
              $('#button-text').show();
              $('#button-loading').hide();
              $('.btn-stafflogin').attr('disabled', false);
          }, 2000);

            $.ajax({
                url: "{{ route('staff.loginaccount') }}",
                type: "POST",
                data: {
                    email: email,
                    password: password,
