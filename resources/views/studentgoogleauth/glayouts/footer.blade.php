           ...
           $.ajax({
                    ...
                    success: function(response){
                        ...
                        if(response.status == 200){
                            ...
                            setTimeout(function (){
                                window.location.href ="{{ route('studentgoogleauth.thesiscapstone') }}";
...
<script>
    $(document).ready(function(){
        ...
        $("#btn-updateProject").on('click', function(e){
           ...
           $.ajax({
                    url:"{{ route('googleauthstudent.updateproject') }}",
                    type:"post",
                    data:data,
                    cache:false,
                    contentType: false,
                    ...
                    success: function(response){
                        ...
                        if(response.status == 200){
                            ...
                            setTimeout(function (){
                                window.location.href ="{{ route('googleauthstudents.status') }}";
...
<script>
    $(document).ready(function(){
        ...
        $("#btn-update-profile").on('click', function(e){
           ...
           $.ajax({
                    url:"{{ route('googleauthstudents.updateProfile') }}",
                    type:"post",
                    data:{
                        fullname: fullname,
                        email: email,
                    ...
                    success: function(res){
                        ...
                        if(res.status == 200){
                            ...
                            setTimeout(function (){
                                window.location.href ="{{ route('googleauthstudents.profile') }}";
    ...
    $(document).ready(function(){
     ...
     function load_data(){
      ...
      function  functionrank(id, slug){
          ...
          $.ajax({
                    url:"{{ route('googleauthstudents.rankcount') }}",
                    type:"post",
                    data:{
                        id: id,
                    ...
                    success: function(res){
                        ...
                        if(res.status == 200){
                            setTimeout(function (){
                                window.location.href ="{{ url('/googleauth/viewmore') }}"+"/"+slug;
      ...
      $(document).on('click', '#btn-deleteproject', function(e){
            ...
            if (!confirm('Are You sure want to delete this Project!')) {
                ...
                $.ajax({
                    ...
                    cache: false,
                    dataType: 'json',
                    url: '{{ route('googleauthstudent.deleteproject') }}',
                    success: function (res) {
                        if(res.status == 200){
                            setTimeout(function (){
                                window.location.href ="{{ route('googleauthstudents.status') }}";
