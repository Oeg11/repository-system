        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              <a href="{{route('dashboard.google')}}" class="nav-link active">
            ...
            <li class="nav-item">
              <a href="{{route('studentgoogleauth.thesiscapstone')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{route('studentgoogleauth.project')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{route('googleauthstudents.profile')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{route('googleauthstudents.status')}}" class="nav-link">
