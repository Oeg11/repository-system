...
<html lang="en">
  ...
  <body>
    <div class="header"><div class="row"><div class="col-md-3"><img src="data:image/png;base64,<?php echo base64_encode(file_get_contents(base_path('public/assets/img/131507_hacker_administrator_system_sys_hack_icon.png'))); ?>" width="80" style=""> </div><div class="col-md-3">Summary of Category Report</div></div></div>
