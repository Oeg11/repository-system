                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <body oncontextmenu="return false" oncopy="return false" oncut="return false" onpaste="return false">
                            <iframe id="pdfFrame" style="pointer-events: none" width="100%" height="600px" src="{{ (!empty($getonethesis->document_path)) ? url('/storage/uploads/'.$getonethesis->document_path.'#toolbar=0') :  url('assets/uploads/No_Image_Available.jpg')}}"></iframe>
                            <script>
