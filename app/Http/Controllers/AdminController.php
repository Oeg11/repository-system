                ...
                //end Absent Part
                 $output .= '
                    ...
                    <tr style="background-color:#e3e2e1">
                              <td colspan="5" style="font-size:1rem">Type: <span style="background-color:#1bdce3;padding: 2px 2px 2px 2px; border-radius:6px;color:#fff">'.$TotalTypes.'</span></td>
                     <td colspan="1" style="font-size:0.8rem"></td>
                              <td colspan="5" style="font-size:1rem">Total Rank: <span style="background-color:#a69d41;padding: 2px 2px 2px 2px; border-radius:6px;color:#fff">'.$TotalRanks.'</span></td>
                    </tr>
                  ';
